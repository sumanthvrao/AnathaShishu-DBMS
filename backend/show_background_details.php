...
<h3 align="center"> List of Children's Background Details ordered by the type of parent </h1>
<center>
...
$query= pg_query($conn, 'SELECT * FROM Child_Background_Details ORDER BY type');
if(!$query)
